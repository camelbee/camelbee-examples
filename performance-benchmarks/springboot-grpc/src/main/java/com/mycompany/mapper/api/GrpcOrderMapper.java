...
public interface GrpcOrderMapper {
  ...
  Order protoToDomainOrder(com.mycompany.order.grpc.Order order);
  ...
  com.mycompany.order.grpc.Order domainToProtoOrder(Order order);
  ...
  OrderItem protoToDomainOrderItem(com.mycompany.order.grpc.OrderItem orderItem);
  ...
  @Mapping(source = "quantity", target = "quantity")
  @Mapping(source = "price", target = "price")
  com.mycompany.order.grpc.OrderItem domainToProtoOrderItem(OrderItem orderItem);

  // Order List mappings
  List<Order> protoToDomainOrders(List<com.mycompany.order.grpc.Order> orders);

  List<com.mycompany.order.grpc.Order> domainToProtoOrders(List<Order> orders);

  // OrderItem List mappings
  List<OrderItem> protoToDomainOrderItems(List<com.mycompany.order.grpc.OrderItem> orderItems);

  List<com.mycompany.order.grpc.OrderItem> domainToProtoOrderItems(List<OrderItem> orderItems);
