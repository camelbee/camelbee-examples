...
public class CreateOrderDomainTestDataProducer extends BaseDomainTestDataProducer {
  ...
  public static final class RequestScenarios {
    ...
    public static final String CREATE_ORDER_ERROR_JDBC_LONG_ITEM_NAME = "createorder-backend-error-jdbc-longitemnamevalue-400-request";
    public static final String CREATE_ORDER_ERROR_JPA_LONG_ITEM_NAME = "createorder-backend-error-jpa-longitemnamevalue-400-request";
   ...
   * with the utility classes under com.mycompany.utils.testdata.*
  ...
  public static List<RequestResponseScenario> generateCreateOrderRequests() {
    ...
    orders.add(RequestResponseScenario.builder().name(RequestScenarios.CREATE_ORDER_ERROR_JDBC_LONG_ITEM_NAME).order(
        generateOrder("", StatusEnum.PENDING, ONLINE_CHANNEL, 2, false, "20", "Product20",
            16, null, null)).transactionId(TXID_FOR_SUCCESS).build());

    orders.add(RequestResponseScenario.builder().name(RequestScenarios.CREATE_ORDER_ERROR_JPA_LONG_ITEM_NAME).order(
        generateOrder("", StatusEnum.PENDING, ONLINE_CHANNEL, 2, false, "30", "Product30",
            8, null, null)).transactionId(TXID_FOR_SUCCESS).build());
