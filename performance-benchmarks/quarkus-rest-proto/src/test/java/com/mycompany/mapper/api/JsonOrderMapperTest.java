...
class JsonOrderMapperTest {
  ...
  class SingleObjectMappingTests {
    ...
    void testJsonToDomainOrder() {
      // Given
      com.mycompany.model.api.json.OrderItem jsonItem = new com.mycompany.model.api.json.OrderItem();
      ...
      com.mycompany.model.api.json.Order jsonOrder = new com.mycompany.model.api.json.Order();
      jsonOrder.setId("order1");
      jsonOrder.setSalesChannel("Online");
      jsonOrder.setStatus(com.mycompany.model.api.json.Order.StatusEnum.COMPLETED);
    ...
    void testDomainToJsonOrder() {
      ...
      // When
      com.mycompany.model.api.json.Order jsonOrder = mapper.domainToJsonOrder(domainOrder);

      // Then
      assertNotNull(jsonOrder);
      assertEquals("order1", jsonOrder.getId());
      assertEquals("Online", jsonOrder.getSalesChannel());
      assertEquals(com.mycompany.model.api.json.Order.StatusEnum.COMPLETED, jsonOrder.getStatus());
      ...
      com.mycompany.model.api.json.OrderItem mappedItem = jsonOrder.getItems().get(0);
      assertEquals("item1", mappedItem.getId());
      assertEquals("prod1", mappedItem.getProductId());
      assertEquals("Product 1", mappedItem.getProductName());
      assertEquals(10, mappedItem.getQuantity());
    ...
    void testDomainToJsonOrderItem() {
      ...
      // When
      com.mycompany.model.api.json.OrderItem jsonItem = mapper.domainToJsonOrderItem(domainItem);
  ...
  class ListMappingTests {
    ...
    void testJsonToDomainOrders() {
      ...
      List<com.mycompany.model.api.json.Order> jsonOrders = Arrays.asList(jsonOrder, jsonOrder);
    ...
    void testDomainToJsonOrders() {
      ...
      // When
      List<com.mycompany.model.api.json.Order> jsonOrders = mapper.domainToJsonOrders(domainOrders);
      ...
      // Verify first item
      com.mycompany.model.api.json.Order firstOrder = jsonOrders.get(0);
      assertEquals("order1", firstOrder.getId());
      assertEquals(com.mycompany.model.api.json.Order.StatusEnum.COMPLETED, firstOrder.getStatus());
    }
    ...
    void testJsonToDomainOrderItems() {
      // Given
      com.mycompany.model.api.json.OrderItem jsonItem1 = new com.mycompany.model.api.json.OrderItem();
      ...
      com.mycompany.model.api.json.OrderItem jsonItem2 = new com.mycompany.model.api.json.OrderItem();
      ...
      List<com.mycompany.model.api.json.OrderItem> jsonItems = Arrays.asList(jsonItem1, jsonItem2);
    ...
    void testDomainToJsonOrderItems() {
      ...
      // When
      List<com.mycompany.model.api.json.OrderItem> jsonItems = mapper.domainToJsonOrderItems(domainItems);
