...
| Kafka | `docker compose exec kafka kafka-console-producer --broker-list localhost:9092 --topic camelbeeService.northbound-createorder-topic-json < test-data.json` |
