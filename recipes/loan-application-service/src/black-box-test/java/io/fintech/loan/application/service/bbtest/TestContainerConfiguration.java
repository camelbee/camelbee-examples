...
public class TestContainerConfiguration {
  ...
  private static final String COMPOSE_FILE = "src/black-box-test/resources/compose-blackbox.yml";
  ...
  static {
    ...
    ENV.withExposedService("cache", 6379, Wait.forListeningPort());
    ...
    waitForHealthEndpoint("http://localhost:" + APP_PORT + "/health", APP_STARTUP_TIMEOUT);
