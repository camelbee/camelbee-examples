...
import io.fintech.loan.application.service.exception.response.ResponseFormatter;
...
public class GlobalErrorProcessor implements Processor {
  ...
  /**
   * List of all available error mappers, injected by Spring.
   * Mappers are automatically discovered via component scanning.
   */
  private final List<ResponseFormatter> mappers;
  /**
