...
class McpOrderMapperTest {
  ...
  class SingleObjectMappingTests {
    ...
    void testMcpToDomainOrder() {
      // Given
      io.fintech.loan.application.service.model.api.mcp.OrderItem mcpItem = new io.fintech.loan.application.service.model.api.mcp.OrderItem();
      mcpItem.setId("item1");
      ...
      io.fintech.loan.application.service.model.api.mcp.Order mcpOrder = new io.fintech.loan.application.service.model.api.mcp.Order();
      mcpOrder.setId("order1");
      mcpOrder.setSalesChannel("Online");
      mcpOrder.setStatus(io.fintech.loan.application.service.model.api.mcp.Order.StatusEnum.COMPLETED);
    ...
    void testDomainToMcpOrder() {
      ...
      // When
      io.fintech.loan.application.service.model.api.mcp.Order mcpOrder = mapper.domainToMcpOrder(domainOrder);

      // Then
      assertNotNull(mcpOrder);
      assertEquals("order1", mcpOrder.getId());
      assertEquals("Online", mcpOrder.getSalesChannel());
      assertEquals(io.fintech.loan.application.service.model.api.mcp.Order.StatusEnum.COMPLETED, mcpOrder.getStatus());
      ...
      io.fintech.loan.application.service.model.api.mcp.OrderItem mappedItem = mcpOrder.getItems().get(0);
      assertEquals("item1", mappedItem.getId());
      assertEquals("prod1", mappedItem.getProductId());
      assertEquals("Product 1", mappedItem.getProductName());
      assertEquals(10, mappedItem.getQuantity());
    ...
    void testDomainToMcpOrderItem() {
      ...
      // When
      io.fintech.loan.application.service.model.api.mcp.OrderItem mcpItem = mapper.domainToMcpOrderItem(domainItem);
  ...
  class ListMappingTests {
    ...
    void testMcpToDomainOrders() {
      ...
      List<io.fintech.loan.application.service.model.api.mcp.Order> mcpOrders = Arrays.asList(mcpOrder, mcpOrder);
    ...
    void testDomainToMcpOrders() {
      ...
      // When
      List<io.fintech.loan.application.service.model.api.mcp.Order> mcpOrders = mapper.domainToMcpOrders(domainOrders);

      // Then
      assertNotNull(mcpOrders);
      assertEquals(2, mcpOrders.size());

      io.fintech.loan.application.service.model.api.mcp.Order firstOrder = mcpOrders.get(0);
      assertEquals("order1", firstOrder.getId());
      assertEquals(io.fintech.loan.application.service.model.api.mcp.Order.StatusEnum.COMPLETED, firstOrder.getStatus());
    }
    ...
    void testMcpToDomainOrderItems() {
      // Given
      io.fintech.loan.application.service.model.api.mcp.OrderItem mcpItem1 = new io.fintech.loan.application.service.model.api.mcp.OrderItem();
      ...
      io.fintech.loan.application.service.model.api.mcp.OrderItem mcpItem2 = new io.fintech.loan.application.service.model.api.mcp.OrderItem();
      ...
      List<io.fintech.loan.application.service.model.api.mcp.OrderItem> mcpItems = Arrays.asList(mcpItem1, mcpItem2);
    ...
    void testDomainToMcpOrderItems() {
      ...
      // When
      List<io.fintech.loan.application.service.model.api.mcp.OrderItem> mcpItems = mapper.domainToMcpOrderItems(domainItems);
