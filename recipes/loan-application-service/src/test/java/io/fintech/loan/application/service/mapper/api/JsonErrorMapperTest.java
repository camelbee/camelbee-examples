...
class JsonErrorMapperTest {
  ...
  void testJsonToDomainError() {
    // Given
    io.fintech.loan.application.service.model.api.json.Error jsonError = new io.fintech.loan.application.service.model.api.json.Error();
  ...
  void testDomainToJsonError() {
    ...
    // When
    io.fintech.loan.application.service.model.api.json.Error jsonError = mapper.domainToJsonError(domainError);
