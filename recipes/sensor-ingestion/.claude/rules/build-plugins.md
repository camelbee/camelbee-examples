...
|-----------|-------|----------------|------|
| REST/MCP API models | `src/main/resources/openapi/order-api.yaml` | `io.iot.sensor.ingestion.model.api.json` | REST, MCP, WebSocket, or JSON formats |
| MCP API models | `src/main/resources/mcp/order-mcp-api.yaml` | `io.iot.sensor.ingestion.model.api.mcp` | MCP interface |
| REST backend models | `src/main/resources/backends/openapi/purchase-api.yaml` | `io.iot.sensor.ingestion.model.infra.json` | REST backend |
