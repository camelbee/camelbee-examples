...
|-----------|-------|----------------|------|
| REST/MCP API models | `src/main/resources/openapi/order-api.yaml` | `com.mycompany.catalog.mcp.model.api.json` | REST, MCP, WebSocket, or JSON formats |
| MCP API models | `src/main/resources/mcp/order-mcp-api.yaml` | `com.mycompany.catalog.mcp.model.api.mcp` | MCP interface |
| REST backend models | `src/main/resources/backends/openapi/purchase-api.yaml` | `com.mycompany.catalog.mcp.model.infra.json` | REST backend |
