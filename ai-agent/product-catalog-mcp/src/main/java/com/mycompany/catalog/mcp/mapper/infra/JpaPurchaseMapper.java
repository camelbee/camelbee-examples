...
public interface JpaPurchaseMapper {
  ...
  Order jpaPurchaseToDomainOrder(com.mycompany.catalog.mcp.model.infra.jpa.postgresql.Purchase purchase);
  ...
  @Mapping(source = "items", target = "items")
  com.mycompany.catalog.mcp.model.infra.jpa.postgresql.Purchase domainOrderToJsonPurchase(Order order);
  ...
  OrderItem jpaPurchaseItemToDomainOrderItem(com.mycompany.catalog.mcp.model.infra.jpa.postgresql.PurchaseItem purchaseItem);
  ...
  @Mapping(source = "quantity", target = "quantity")
  @Mapping(source = "price", target = "price")
  com.mycompany.catalog.mcp.model.infra.jpa.postgresql.PurchaseItem domainOrderItemToJsonPurchaseItem(OrderItem orderItem);

  // Order List mappings
  List<Order> jpaPurchasesToDomainOrders(List<com.mycompany.catalog.mcp.model.infra.jpa.postgresql.Purchase> purchases);

  List<com.mycompany.catalog.mcp.model.infra.jpa.postgresql.Purchase> domainOrdersToJsonPurchases(List<Order> orders);

  // OrderItem List mappings
  List<OrderItem> jpaToDomainOrderItems(List<com.mycompany.catalog.mcp.model.infra.jpa.postgresql.PurchaseItem> purchaseItems);

  List<com.mycompany.catalog.mcp.model.infra.jpa.postgresql.PurchaseItem> domainToJsonOrderItems(List<OrderItem> orderItems);
