...
import com.mycompany.catalog.mcp.bbtest.CreateOrderBlackBoxTest;
...
public class McpInterfaceCreateOrderBlackBoxTest extends CreateOrderBlackBoxTest {
  ...
  void given_ValidOrder_When_McpCreateOrderCalled_Then_ResultIsSuccess(String fileName, String transactionId) throws Exception {
    ...
    try {
      var result = mcpClient.callToolWithOrderNamed("createOrder", "order",
  ...
  void given_InValidOrder_When_McpCreateOrderCalled_And_InterfaceReturnedBadRequest_Then_ResultIsBadRequest(String fileName, String transactionId) throws Exception {
