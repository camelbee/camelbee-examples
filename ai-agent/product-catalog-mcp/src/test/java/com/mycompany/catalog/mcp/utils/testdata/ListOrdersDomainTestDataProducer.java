...
public class ListOrdersDomainTestDataProducer extends BaseDomainTestDataProducer {
  ...
  public static List<RequestResponseScenario> generateListOrdersRequests() {
    ...
    orders.add(RequestResponseScenario.builder().transactionId(TXID_FOR_SUCCESS).name(RequestScenarios.LIST_ORDERS_ERROR_EMPTY_SALES_CHANNEL).salesChannel(null).order(
