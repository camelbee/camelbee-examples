...
class McpOrderMapperTest {
  ...
  class SingleObjectMappingTests {
    ...
    void testMcpToDomainOrder() {
      // Given
      com.mycompany.catalog.mcp.model.api.mcp.OrderItem mcpItem = new com.mycompany.catalog.mcp.model.api.mcp.OrderItem();
      mcpItem.setId("item1");
      ...
      com.mycompany.catalog.mcp.model.api.mcp.Order mcpOrder = new com.mycompany.catalog.mcp.model.api.mcp.Order();
      mcpOrder.setId("order1");
      mcpOrder.setSalesChannel("Online");
      mcpOrder.setStatus(com.mycompany.catalog.mcp.model.api.mcp.Order.StatusEnum.COMPLETED);
    ...
    void testDomainToMcpOrder() {
      ...
      // When
      com.mycompany.catalog.mcp.model.api.mcp.Order mcpOrder = mapper.domainToMcpOrder(domainOrder);

      // Then
      assertNotNull(mcpOrder);
      assertEquals("order1", mcpOrder.getId());
      assertEquals("Online", mcpOrder.getSalesChannel());
      assertEquals(com.mycompany.catalog.mcp.model.api.mcp.Order.StatusEnum.COMPLETED, mcpOrder.getStatus());
      ...
      com.mycompany.catalog.mcp.model.api.mcp.OrderItem mappedItem = mcpOrder.getItems().get(0);
      assertEquals("item1", mappedItem.getId());
      assertEquals("prod1", mappedItem.getProductId());
      assertEquals("Product 1", mappedItem.getProductName());
      assertEquals(10, mappedItem.getQuantity());
    ...
    void testDomainToMcpOrderItem() {
      ...
      // When
      com.mycompany.catalog.mcp.model.api.mcp.OrderItem mcpItem = mapper.domainToMcpOrderItem(domainItem);
  ...
  class ListMappingTests {
    ...
    void testMcpToDomainOrders() {
      ...
      List<com.mycompany.catalog.mcp.model.api.mcp.Order> mcpOrders = Arrays.asList(mcpOrder, mcpOrder);
    ...
    void testDomainToMcpOrders() {
      ...
      // When
      List<com.mycompany.catalog.mcp.model.api.mcp.Order> mcpOrders = mapper.domainToMcpOrders(domainOrders);

      // Then
      assertNotNull(mcpOrders);
      assertEquals(2, mcpOrders.size());

      com.mycompany.catalog.mcp.model.api.mcp.Order firstOrder = mcpOrders.get(0);
      assertEquals("order1", firstOrder.getId());
      assertEquals(com.mycompany.catalog.mcp.model.api.mcp.Order.StatusEnum.COMPLETED, firstOrder.getStatus());
    }
    ...
    void testMcpToDomainOrderItems() {
      // Given
      com.mycompany.catalog.mcp.model.api.mcp.OrderItem mcpItem1 = new com.mycompany.catalog.mcp.model.api.mcp.OrderItem();
      ...
      com.mycompany.catalog.mcp.model.api.mcp.OrderItem mcpItem2 = new com.mycompany.catalog.mcp.model.api.mcp.OrderItem();
      ...
      List<com.mycompany.catalog.mcp.model.api.mcp.OrderItem> mcpItems = Arrays.asList(mcpItem1, mcpItem2);
    ...
    void testDomainToMcpOrderItems() {
      ...
      // When
      List<com.mycompany.catalog.mcp.model.api.mcp.OrderItem> mcpItems = mapper.domainToMcpOrderItems(domainItems);
